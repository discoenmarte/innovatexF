...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        if (storedSessionData) {
            setIframeSrc("https://bot.aitopstaff.com/innova/?data=" + encodeURIComponent(storedSessionData));
        }
    ...
    useEffect(() => {
        if (session && status === 'authenticated') {
            ...
            if (sessionRef.current !== session && !iframeSrc) {
                ...
                setIframeSrc("https://bot.aitopstaff.com/innova/?data=" + encodeURIComponent(encryptedData));
            }
        }
